...
var Player = function () {
  ...
  _createClass(Player, [{
    key: 'addCard',
    value: function addCard(card, activePlayer) {
...
var buttons = function () {
  ...
  function toggleDeal(status) {
    if (status) {
      ...
      $deal.prop('disabled', function (i, v) {
        return !v;
      });
    }
  }
  ...
  function toggleDouble() {
    $double.prop('disabled', function (i, v) {
      return !v;
    });
    render.doubleButton();
  }
  ...
  function toggleNewGame() {
    $newGame.prop('disabled', function (i, v) {
      return !v;
    });
  }

  function toggleSplit() {
    $split.prop('disabled', function (i, v) {
      return !v;
    });
    render.splitButton();
  }
  ...
  function toggleStandAndHit() {
    $stand.prop('disabled', function (i, v) {
      return !v;
    });
    $takeCard.prop('disabled', function (i, v) {
      return !v;
    });
  }
...
var $ = __webpack_require__(1);
var Balance = __webpack_require__(5);
...
var Balance = function () {
  ...
  _createClass(Balance, [{
    ...
    value: function insufficientFunds() {
      if (this.total < 25) {
        return true;
      }
    }
    ...
    key: 'reduce',
    value: function reduce(bet) {
      this.total -= bet;
      render.balance(this.total);
    }
  }, {
    key: 'procesResult',
    value: function procesResult(user) {
...
var Card = function Card(specie, number, value) {
...
var Dealer = function (_Player) {
  ...
  function Dealer() {
    ...
    render.createDealer();
    _this.id = 'Dealer';
    _this.scoreContainer = '#scoreDealer';
    _this.cardContainer = '#cardsDealer';
    return _this;
  }

  _createClass(Dealer, [{
    key: 'hideCardDealer',
    value: function hideCardDealer(status, activePlayer) {
      if (status) {
...
var User = function (_Player) {
  ...
  function User(index, split, oldPlayer) {
    _classCallCheck(this, User);

    var _this = _possibleConstructorReturn(this, (User.__proto__ || Object.getPrototypeOf(User)).call(this));

    render.createUser(index, split, oldPlayer);
    _this.userContainer = '#user' + index;
    _this.scoreContainer = '#scoreUser' + index;
    _this.cardContainer = '#cardsUser' + index;
    _this.betContainer = '#betUser' + index;
    _this.statusSplit = split;
    return _this;
  }

  _createClass(User, [{
    key: 'checkDouble',
    value: function checkDouble() {
      var check = 0;
    ...
    key: 'checkSplit',
    value: function checkSplit(users, maxUsers) {
      if (this.cards[0].value === this.cards[1].value && users < maxUsers) {
        buttons.toggleSplit();
      }
    }
  }, {
    key: 'determineOptions',
    value: function determineOptions(users, maxUsers, balanceTotal) {
    ...
    key: 'doubleBet',
    value: function doubleBet(activePlayer) {
      this.statusDouble = true;
      render.bet(this.bet, activePlayer);
      this.bet = this.bet * 2;
    }
  }, {
    key: 'processDoubleScore',
    value: function processDoubleScore(activePlayer) {
    ...
    key: 'removeHTML',
    value: function removeHTML(obsoleteUser) {
      render.removeUserHTML(obsoleteUser);
    }
  }, {
    key: 'removeSplitCard',
    value: function removeSplitCard(player) {
      var removedCard;
    ...
    key: 'setBet',
    value: function setBet(bet, activePlayer) {
      this.bet = bet;
...
var setOpeningBalance = 1000;
var setUsers = 1;
var setMaxUsers = 2;
var setPacks = 6;

game.start(setUsers, setMaxUsers, setPacks, setOpeningBalance);

/*
  - CLean HTML with META tages and comments
  - Add dot if balance is over 1000. Also add decimals?
  - Make buttons clickable fit the icon as a whole.
  - Discribe the way the game is set up with modules, (super)classes and communication
    for readme on github
  - research possibilities for using this when passing activePlayer
  - max number of cards per user for UI control?
*/

/*
  - Small changes to UI.
  - Split possibilities changed to same card value instead of card number
  - Newplayer status set to inplay is true after split
*/
